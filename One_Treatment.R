...
file_path = "/Users/martinvo/Library/CloudStorage/OneDrive-XavierUniversity/Dr. Escorcia Research/Lab Program Codes/PROJECT POMBE (PP)/TOOL - NNImageProcessing/PP EMM_YES"
...
for(i in 1:length(file_list)){
  ...
  if(length(count.fields(paste0(file_path, "/", file_list[i]))) > 1){
    ...
    temp_data$condition = ifelse(str_detect(file_list[i], pattern = "EMM"), "EMM", "YES")
...
if(unique(uv_nt$condition)[2] == "EMM"){
